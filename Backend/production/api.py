...
Endpoints:
    POST /api/process - Process a prompt with RL optimization
...
def process_prompt_api():
    ...
    Expected JSON payload:
    {
        ...
        "include_response": true  // Optional: whether to generate LLM response
    }
    ...
    Returns:
    {
        ...
        "data": {
            ...
            "category": "coding",
            "response": "..." // Only if include_response=true
        },
        "processing_time": 2.3,
